...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        if (TURNSTILE_SITE_KEY) {
          showToast(
            'We had trouble loading the verification widget. Please refresh the page or try again later.',
            'error'
          )
        }
      }
  ...
  async function handleRegister(e: React.FormEvent<HTMLFormElement>) {
    ...
    const immediateModerationError = validateTextInput(username.trim())
    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 px-4'>
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            console.log("═══════════════════════════════════════════════════════════");
            console.log("🚀 Frontend: Register with Google button clicked");
            console.log("═══════════════════════════════════════════════════════════");
            
            // Set cookie with appropriate SameSite attribute based on environment
            console.log("🍪 Setting OAuth intent cookie (register)...");
            ...
            const oauthUrl = `${API_BASE}/oauth2/authorization/google?intent=register&redirect_uri=${redirectUrl}`;
            ...
            console.log("═══════════════════════════════════════════════════════════");
            console.log("✅ Frontend: OAuth redirect initiated (REGISTER)");
            console.log("═══════════════════════════════════════════════════════════");
